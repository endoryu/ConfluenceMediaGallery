...
| CS-DEV-SPACE | Developer Space | 請求アカウント設定・請求同意のみ。支払方法未登録。Usage 0、USD 0.00 | 請求同意済み・支払方法未登録。App登録済み(Confluence Media Gallery、Space: CMGdev)。全メトリクス0/利用実績なし、USD 0.00(baseline 9/18、Phase 0後 `usage-snapshots/2026-09-19-phase0.json`。9/19実施分の最終確認は次回12:00 UTC更新後) | 2026-09-18 | 2026-09-19 | ユーザー |
