...
| CS-DEV-SPACE | Developer Space | 請求アカウント設定・請求同意のみ。支払方法未登録。Usage 0、USD 0.00 | 請求同意済み・支払方法未登録。App登録済み(Confluence Media Gallery、Space: CMGdev)。全メトリクス0/利用実績なし、USD 0.00(baseline 9/18、Phase 0後 `2026-09-19-phase0.json`確定、Phase 1後 `2026-09-19-phase1.json`確定 — いずれも2026-09-20の12:00 UTC更新後にユーザー目視) | 2026-09-18 | 2026-09-20 | ユーザー |
